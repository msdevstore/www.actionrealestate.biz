$(document).ready(function() {
    ...
    $('#file-six-btn').click(function() {
        var folder = $('#close-transaction-dropdown').val();
        if(!folder) folder = $('#close-created-folder-title h4').html();
        var formData = new FormData();
    ...
    $('#download-close').click(function() {
        modalOpen("final-modal-close");
    })

    $('#final-modal-close-no-btn').click(function() {
        $('#download-close-ok').click();
    })
    ...
    function getNumber(_str){
      ...
      $('#gross-commission-amoucreate-foldernt').on('keyup',function(){
        updateTextView($(this));
      });
