<?php
    ...
    require "includes/headInfo.inc.php";
...
?>
    ...
    <main>
        <div class="main-content px-2">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-ms-12" id="public">
                    <div class="d-flex justify-content-between">
                        <h5 class="text-primary pt-2">Public Data</h5>
                        <button class="btn btn-primary save-modal-btn" root="pub">File Upload</button>
                    </div>
