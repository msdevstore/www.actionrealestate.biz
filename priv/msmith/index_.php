...
<div class="wrapper">
    ...
    <table width="99%" border="1">
        ...
        <tr>
            <td colspan="3" align="center">Below here for uploading Listings NOT READY YET</td>
        </tr>
            ...
            <td>
                ...
                <div id="list-contract" class="mt-5 mb-5" style="display: none">
                    ...
                    <div class="form-container">
                        ...
                        <div class="form-group">
                            <label>House #</label>
                            <input type="text" class="form-control" name="" id="list-start-house">
                        </div>
                        <div class="form-group">
...
<!--                            </div>-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-2"><button type="button" class="btn btn-secondary doc-btn" id="download-close" data-dismiss="modal">Close</button></div>
                        </div>
                    </div>
                </div>
